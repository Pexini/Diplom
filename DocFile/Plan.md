...
<h6> Выполняем поочередные проверки для: </h6>

<li> дебетовой карте на <a href="//localhost:8080/api/v1/pay" >Дебетовая карта </a> </li>
<li> кредитной карте на <a href="//localhost:8080/api/v1/credit" >Кредитная карта </a> </li>
